...
"""
Step 4 (VINA, exhaustiveness=32): Analyze Vina docking results written to `autodock_vina_32`.

This is a copy of `04_analyze_vina.py` adapted to read outputs under
`autodock_vina_32` and write predictions to `predictions/autodock_vina_32.csv`.
"""
...
OUTPUT_DIR = Path("/home/rquiroga/Datasets/runs-n-poses-datasets/autodock_vina_32")
ANALYSIS_DIR = Path("/home/rquiroga/github/runs-n-poses/examples/analysis/vina_32")
ANNOTATIONS = Path("/home/rquiroga/Datasets/runs-n-poses-datasets/annotations.csv")
OUTPUT_CSV = Path("/home/rquiroga/Datasets/runs-n-poses-datasets/predictions/autodock_vina_32.csv")

POSEBUSTERS_CSV = Path("/home/rquiroga/Datasets/runs-n-poses-datasets/posebusters_results/autodock_vina_32.csv")
...
def analyze_system(system_id: str, annotations: pd.DataFrame, run_posebusters_flag: bool = True,
    ...
    for lig_dir in sorted(system_out.iterdir()):
        ...
        if run_posebusters_flag:
            ...
            pb_row.setdefault("method", "autodock_vina_32")
...
def main():
    ...
    total_metrics = 0
    for sid in tqdm(system_ids, desc="Analyzing (Vina32)"):
        ...
        if pb_rows and run_pb_for_system:
            ...
            for c, default in [("system_id", sid), ("seed", 1), ("sample", 1), ("ligand_chain", None), ("method", "autodock_vina_32")]:
