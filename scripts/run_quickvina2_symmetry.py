...
def run_quickvina2(receptor_file, ligand_file, output_dir, sys_id, lig_chain,
    ...
    try:
        ...
        with open(runtime_file, "w") as fh:
            json.dump({"method": "quickvina2", "returncode": result.returncode,
...
def main():
    parser = argparse.ArgumentParser(description="Run QuickVina2 (scip-qvina) on symmetry-corrected receptors")
